...
<head>
	...
	<title>Student Registrarion</title>
		...
		<div class="box2">
            ...
            <form name="Registration" action="" method="post">
            	<div class="registration">
                 ...
                 <input class="form-control" type="text" name="roll" placeholder="Roll Number" required=""> <br>
	...
	<?php
	     ...
	     if(isset($_POST['submit']))
	     {
            ...
            if($count==0){
	             ...
	             '$_POST[username]','$_POST[password]','$_POST[roll]','$_POST[email]','$_POST[contact]','admin.png');");
